...
public class PlaceholderFragmentFriend extends Fragment {
    /**
    ...
    public PlaceholderFragmentFriend() {
    }
     ...
     * number.
     */
    public static PlaceholderFragmentFriend newInstance(final int sectionNumber) {
        final PlaceholderFragmentFriend fragment = new PlaceholderFragmentFriend();
